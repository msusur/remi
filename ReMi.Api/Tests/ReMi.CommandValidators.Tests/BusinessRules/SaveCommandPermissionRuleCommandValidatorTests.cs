...
{
    public class SaveCommandPermissionRuleCommandValidatorTests : TestClassFor<SaveCommandPermissionRuleCommandValidator>
    {
        protected override SaveCommandPermissionRuleCommandValidator ConstructSystemUnderTest()
        {
            return new SaveCommandPermissionRuleCommandValidator();
        }
        ...
        public void Validate_ShouldNotPass_WhenRuleHasEmptyFillouts()
        {
            ...
            Assert.AreEqual("CommandId", result.Errors.ElementAt(11).PropertyName);
        }
