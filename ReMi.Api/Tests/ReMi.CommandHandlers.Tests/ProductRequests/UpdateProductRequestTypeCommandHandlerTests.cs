...
{
    public class UpdateProductRequestTypeCommandHandlerTests : TestClassFor<UpdateProductRequestTypeCommandHandler>
    {
        private Mock<IProductRequestGateway> _productRequestGatewayMock;

        protected override UpdateProductRequestTypeCommandHandler ConstructSystemUnderTest()
        {
            return new UpdateProductRequestTypeCommandHandler
            {
        ...
        public void Handle_ShouldCallGateway_WhenInvoked()
        {
            ...
            var command = new UpdateProductRequestTypeCommand
            {
                RequestType = type
            };
            ...
            _productRequestGatewayMock.Verify(o => o.UpdateProductRequestType(type));
        }
    }
}
