...
{
    public class CreateProductRequestRegistrationCommandValidator : RequestValidatorBase<CreateProductRequestRegistrationCommand>
    {
        public CreateProductRequestRegistrationCommandValidator()
        {
