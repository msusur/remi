...
{
    public class SaveCommandPermissionRuleCommandHandlerTests : TestClassFor<SaveCommandPermissionRuleCommandHandler>
    {
        private Mock<IBusinessRuleGateway> _businessRuleGatewayMock;
        private Mock<IBusinessRuleEngine> _businessRuleEngineMock;

        protected override SaveCommandPermissionRuleCommandHandler ConstructSystemUnderTest()
        {
            return new SaveCommandPermissionRuleCommandHandler
            {
        ...
        {
            var command = new SaveCommandPermissionRuleCommand
            {
        ...
        public void Handle_ShouldCreateAndAssignRuleToCommand_WhenRuleNotExist()
        {
            ...
            _businessRuleGatewayMock.Setup(x => x.AddRuleToCommand(command.Rule.ExternalId, command.CommandId));
            ...
            _businessRuleGatewayMock.Verify(x => x.AddRuleToCommand(It.IsAny<Guid>(), It.IsAny<int>()), Times.Once());
        }
