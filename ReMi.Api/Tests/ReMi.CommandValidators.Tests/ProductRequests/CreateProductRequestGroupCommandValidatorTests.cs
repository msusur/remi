...
{
    [TestFixture]
    public class CreateProductRequestGroupCommandValidatorTests : TestClassFor<CreateProductRequestGroupCommandValidator>
    {
        protected override CreateProductRequestGroupCommandValidator ConstructSystemUnderTest()
        {
            return new CreateProductRequestGroupCommandValidator();
        }
        ...
        public void Validate_ShouldNotPass_WhenProductRequestTypeIdEmpty()
        {
            ...
            Assert.IsFalse(result.IsValid);
            Assert.AreEqual(1, result.Errors.Count);
            Assert.AreEqual("RequestGroup.ProductRequestTypeId", result.Errors.ElementAt(0).PropertyName);
        }
