...
{
    public class CreateProductRequestGroupCommandValidator : RequestValidatorBase<CreateProductRequestGroupCommand>
    {
        public CreateProductRequestGroupCommandValidator()
        {
            ...
            RuleFor(o => o.RequestGroup.ProductRequestTypeId).NotEmpty();
