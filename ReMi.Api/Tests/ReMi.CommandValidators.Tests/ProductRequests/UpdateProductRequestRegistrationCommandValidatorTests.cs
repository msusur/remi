...
{
    [TestFixture]
    public class UpdateProductRequestRegistrationCommandValidatorTests : TestClassFor<UpdateProductRequestRegistrationCommandValidator>
    {
        protected override UpdateProductRequestRegistrationCommandValidator ConstructSystemUnderTest()
        {
            return new UpdateProductRequestRegistrationCommandValidator();
        }
